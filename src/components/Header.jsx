      ...
      <div className="mx-auto w-dvw px-6 py-3 flex lg:justify-center lg:gap-150 gap-12">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <h1 className="text-sm font-semibold leading-tight">Akki Photography</h1>
            <p className="text-xs text-slate-300">Fine Art & Commercial Photographer</p>
          </div>
        </div>
        ...
        <nav className="flex items-center" role="navigation" aria-label="Primary">
          ...
          <a href="#work" className="text-sm text-slate-300 hover:text-white ml-4">Work</a>
          <a href="#contact" className="text-sm text-slate-300 hover:text-white ml-4">Contact</a>
